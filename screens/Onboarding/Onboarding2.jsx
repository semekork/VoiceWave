  ...
  return (
    <>
      ...
      >
        ...
        <OnboardingIndicator total={3} activeIndex={1} />
          ...
          <View style={styles.taglineContainer}>
            ...
            Curated podcasts built for learners in Ghana — listen, grow, and stay inspired.
            </Text>
          </View>
          
          <View style={styles.backgroundLetters}>
            <Text style={styles.backgroundLettersText}>CONNECT</Text>
          </View>
          
          {/* microphone Tape Image with Floating Animation */}
          <Animated.View style={[styles.microphoneContainer, floatingStyle]}>
            <Image
